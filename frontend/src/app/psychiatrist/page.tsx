              ...
              >
                ...
                <div className="p-8">
                  ...
                  <p className="text-gray-700 mb-6 leading-relaxed">
                    ...
                    assistant that provides empathetic support and guidance for
              ...
              <div className="bg-white shadow-lg rounded-xl border border-gray-100 p-8">
                ...
                <div className="flex flex-wrap gap-3 border-t border-gray-200 pt-5">
                  <div className="flex items-center text-sm text-gray-700">
                    <FiShield className="mr-1 text-blue-600" /> HIPAA Compliant
                  </div>
                  <div className="flex items-center text-sm text-gray-700">
                    <FiBriefcase className="mr-1 text-blue-600" /> Professional
                    Grade
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-lg font-semibold mb-2">Editable Reports</h3>
                <p className="text-gray-600">
                  Customize AI-generated reports with your professional insights
                  and observations
                </p>
              </div>
